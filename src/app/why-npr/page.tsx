        ...
        >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <p className="mt-10 text-center text-sm font-semibold text-gray-600">
              AI isn’t the only pitfall. Bloated agencies slow you down, too.
              Keep scrolling to learn how our lean team delivers better results.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="text-center md:text-left space-y-4">
                ...
                <p className="text-[clamp(0.9rem,1.6vw,1.125rem)] text-gray-600">AI alone can’t own your metrics, and neither can bloated agencies. Most shops sell time&mdash;we sell outcomes.</p>
