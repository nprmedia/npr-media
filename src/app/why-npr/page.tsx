  ...
  return (
    <section>
      ...
      >
        ...
        <section
          id="vs-ai"
          className="relative overflow-hidden bg-umber py-20 text-silver"
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-blood via-crimson to-blood opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
                ...
                <div className="space-y-2 pb-8 text-center md:pb-0 md:text-left">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-block rounded-full bg-gradient-to-r from-blood to-crimson px-4 py-2 text-xs font-semibold text-silver shadow transition hover:scale-105"
                    >
                      See the difference
                    </a>
                  </div>
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-blood to-crimson px-6 py-3 text-sm font-semibold text-silver shadow-md ring-1 ring-silver/10 transition hover:scale-105"
              >
                Don’t get AI’d. Get outcomes.
              </a>
            </div>
            <p className="mt-10 text-center text-sm font-semibold text-sepia">
        ...
        <section id="vs-firms" className="relative overflow-hidden bg-antique py-20 text-charcoal">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute right-1/2 bottom-0 h-96 w-96 translate-x-1/2 rounded-full bg-gradient-to-br from-blood via-crimson to-blood opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                    className="inline-block rounded-full bg-gradient-to-r from-blood to-crimson px-6 py-3 text-sm font-semibold text-silver shadow-md ring-1 ring-charcoal/10 transition hover:scale-105"
              >
