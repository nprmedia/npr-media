      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[var(--color-accent)] opacity-20 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="text-center space-y-2">
              <h1 className="text-[clamp(2rem,4vw,3rem)] font-extrabold tracking-tight text-[var(--color-accent)]">AI Guesswork vs Human Strategy</h1>
            ...
            <div className="space-y-12">
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
                  <h2 className="text-3xl sm:text-4xl font-bold text-[var(--color-accent)]">What AI Can’t Do</h2>
                  <p className="text-sm text-[var(--color-gray-300)]">Where automation falls short</p>
                  <div className="pt-2">
                    <a
                      href="/pricing"
              ...
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
                  <h2 className="text-3xl sm:text-4xl font-bold text-[var(--color-accent)]">How NPR Media Delivers</h2>
                  <p className="text-sm text-[var(--color-gray-300)]">Human-guided strategy for real results</p>
                  <div className="pt-2">
                    <a
                      href="/pricing"
                      className="inline-block rounded-full bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-dark)] px-4 py-2 text-xs font-semibold text-white shadow transition hover:scale-105"
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute bottom-0 right-1/2 h-96 w-96 translate-x-1/2 rounded-full bg-[var(--color-accent)] opacity-20 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="text-center md:text-left space-y-4">
                <h1 className="text-[clamp(2rem,4vw,3rem)] font-extrabold tracking-tight text-[var(--color-accent)]">Agency Bloat vs NPR Media</h1>
            ...
            <div className="grid gap-8 text-sm md:grid-cols-2">
              ...
              >
                <p className="text-lg font-semibold text-[var(--color-accent)]">What other firms drag you through</p>
              ...
              <motion.div
                ...
                className="space-y-2 rounded-xl bg-white p-6 shadow-md text-gray-800"
              >
                <p className="text-lg font-semibold text-[var(--color-accent)]">How we keep projects moving</p>
