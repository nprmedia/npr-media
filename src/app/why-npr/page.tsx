  ...
  return (
    <section>
      ...
      >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <div className="space-y-12">
                ...
                <div className="space-y-2 pb-8 text-center md:pb-0 md:text-left">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-4 py-2 text-xs font-semibold text-muted-foreground shadow transition hover:scale-105"
                    >
                      See the difference
                    </a>
                  </div>
              ...
              <div className="space-y-1 text-center">
                <h2 className="text-xl font-bold text-muted-foreground">Here&rsquo;s where we step in</h2>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="rounded-xl bg-muted/10 p-6 text-muted-foreground shadow-lg"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative mt-12 flex items-start justify-center rounded-xl bg-muted/5 p-6 text-muted-foreground shadow-lg md:p-8"
            >
              ...
              <div className="w-1/2 pl-4 text-sm">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="rounded border border-muted/30 bg-muted/10 p-3 text-muted-foreground shadow-inner"
                >
                  Bold hook → stat → CTA
                </motion.div>
              </div>
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-6 py-3 text-sm font-semibold text-muted-foreground shadow-md ring-1 ring-muted/10 transition hover:scale-105"
              >
        ...
        <WaveDivider className="text-muted-foreground" />
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-6 py-3 text-sm font-semibold text-muted-foreground shadow-md ring-1 ring-muted/20 transition hover:scale-105"
              >
        ...
        <WaveDivider flip className="text-muted-foreground" />
      </main>
      <FinalCTA />
      <FooterSection />
    </section>
