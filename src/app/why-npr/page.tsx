      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-[var(--color-blood)] to-[var(--color-crimson)] opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="space-y-2 text-center">
              ...
              <p className="mx-auto max-w-xl text-sm text-[var(--color-antique)]">
            ...
            <div className="space-y-12">
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="space-y-2 pb-8 text-center md:pb-0 md:text-left">
                  ...
                  <p className="text-sm text-[var(--color-antique)]">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-block rounded-full bg-gradient-to-r from-[var(--color-blood)] to-[var(--color-crimson)] px-4 py-2 text-xs font-semibold text-[var(--color-silver)] shadow transition hover:scale-105"
                    >
                      See the difference
                    </a>
                  </div>
              ...
              <div className="space-y-1 text-center">
                <h2 className="text-xl font-bold text-[var(--color-silver)]">Here&rsquo;s where we step in</h2>
                <p className="text-sm text-[var(--color-sepia)]">
                  Real humans refine the data and own the outcome.
                </p>
                <ScrollCue
                  href="#npr-delivers"
                  className="mx-auto mt-2 text-[var(--color-blood)]"
                />
              </div>
            ...
            <p className="mx-auto mt-6 max-w-xl text-center text-sm text-[var(--color-antique)]">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="rounded-xl bg-[var(--color-antique)]/10 p-6 text-[var(--color-silver)] shadow-lg"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative mt-12 flex items-start justify-center rounded-xl bg-[var(--color-antique)]/5 p-6 text-[var(--color-silver)] shadow-lg md:p-8"
            >
              ...
              <div className="absolute top-1/2 left-1/2 h-10 w-px -translate-y-1/2 transform bg-[var(--color-silver)]/30" />
              <div className="w-1/2 pl-4 text-sm">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="rounded border border-[var(--color-silver)]/30 bg-[var(--color-antique)]/10 p-3 text-[var(--color-silver)] shadow-inner"
                >
                  Bold hook → stat → CTA
                </motion.div>
              </div>
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-[var(--color-blood)] to-[var(--color-crimson)] px-6 py-3 text-sm font-semibold text-[var(--color-silver)] shadow-md ring-1 ring-white/10 transition hover:scale-105"
              >
                Don’t get AI’d. Get outcomes.
              </a>
            </div>
            <p className="mt-10 text-center text-sm font-semibold text-[var(--color-charcoal)]">
            ...
            <ScrollCue href="#vs-firms" className="mx-auto mt-4 text-[var(--color-blood)]" />
          </div>
        </section>
        <WaveDivider className="text-[var(--color-silver)]" />

        {/* SECTION 2: NPR Media vs Other Firms */}
        <section id="vs-firms" className="relative overflow-hidden bg-[var(--color-antique)] py-20 text-[var(--color-charcoal)]">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute right-1/2 bottom-0 h-96 w-96 translate-x-1/2 rounded-full bg-gradient-to-br from-[var(--color-blood)] to-[var(--color-crimson)] opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="space-y-4 text-center md:text-left">
                ...
                <p className="text-[clamp(0.9rem,1.6vw,1.125rem)] text-[var(--color-charcoal)]">
                  AI tools won&rsquo;t own your numbers&mdash;and neither will bloated agencies.
                  While others bill hours, we deliver outcomes.
                </p>
                <p className="mx-auto max-w-xl text-sm text-[var(--color-charcoal)] md:mx-0">
            ...
            <p className="text-center text-sm font-semibold text-[var(--color-sepia)]">
            ...
            <div className="grid gap-8 text-sm md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="space-y-2 rounded-xl bg-[var(--color-antique)] p-6 text-[var(--color-charcoal)] shadow-md"
              >
                <p className="text-lg font-semibold">What other firms drag you through</p>
                <p className="text-sm text-[var(--color-sepia)]">Extras you don&rsquo;t actually need</p>
                <div className="pt-2">
                  <a
                    href="/webdev-landing"
                    data-event="cta-social-proof"
              ...
              >
                ...
                <p className="text-sm text-[var(--color-sepia)]">The NPR no-bloat process</p>
                <div className="pt-2">
                  <a
                    href={Routes.contact}
                ...
                <ul className="space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-[var(--color-blood)]" />
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-[var(--color-blood)] to-[var(--color-crimson)] px-6 py-3 text-sm font-semibold text-[var(--color-silver)] shadow-md ring-1 ring-black/10 transition hover:scale-105"
              >
                This time, don’t settle.
              </a>
            </div>
            <ScrollCue href="#footer" className="mx-auto mt-4 text-[var(--color-blood)]" />
          </div>
        </section>
        <WaveDivider flip className="text-[var(--color-silver)]" />
      </main>
      <FinalCTA />
      <FooterSection />
    </section>
