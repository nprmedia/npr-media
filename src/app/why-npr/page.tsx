        ...
        >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <p className="mt-10 text-center text-sm font-semibold text-gray-600">
              Ready to see how our hands-on model stacks up against bloated agencies?
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="text-center md:text-left space-y-4">
                ...
                <p className="text-[clamp(0.9rem,1.6vw,1.125rem)] text-gray-600">You&rsquo;ve seen how AI falls short—now here&rsquo;s why old-school agencies do too.</p>
                <p className="mx-auto max-w-xl text-sm text-gray-600 md:mx-0">Most agencies sell time. We sell outcomes. Big shops pad projects with junior talent and endless steps. Our senior strike team ships fast and owns the metrics.</p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
