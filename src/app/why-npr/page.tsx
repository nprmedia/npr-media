        ...
        >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <p className="mt-10 text-center text-sm font-semibold text-gray-600">
              AI alone won&apos;t grow your business. But how do ordinary agencies
              stack up? Let&apos;s compare.
            </p>
          </div>
        </section>
            ...
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="text-center md:text-left space-y-4">
                ...
                <p className="text-[clamp(0.9rem,1.6vw,1.125rem)] text-gray-600">
                  Most agencies bill for time—they rarely measure results.
                </p>
                <p className="mx-auto max-w-xl text-sm text-gray-600 md:mx-0">
                  You’ve seen where automation falls short. Big agencies bloat the
                  process with junior talent and endless steps. Our senior strike
                  team ships fast and owns the metrics.
                </p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 40 }}
