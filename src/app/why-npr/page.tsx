      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-accent via-pink-500 to-accent opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="space-y-2 text-center">
              ...
              <p className="mx-auto max-w-xl text-sm text-foreground">
            ...
            <div className="space-y-12">
                ...
                <div className="space-y-2 pb-8 text-center md:pb-0 md:text-left">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-4 py-2 text-xs font-semibold text-foreground shadow transition hover:scale-105"
                    >
                      See the difference
                    </a>
                  </div>
              ...
              <div className="space-y-1 text-center">
                <h2 className="text-xl font-bold text-foreground">Here&rsquo;s where we step in</h2>
                <p className="text-sm text-foreground">
            ...
            <p className="mx-auto mt-6 max-w-xl text-center text-sm text-foreground">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="rounded-xl bg-silver/10 p-6 text-foreground shadow-lg"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative mt-12 flex items-start justify-center rounded-xl bg-silver/5 p-6 text-foreground shadow-lg md:p-8"
            >
              ...
              <div className="w-1/2 pl-4 text-sm">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="rounded border border-silver/30 bg-silver/10 p-3 text-foreground shadow-inner"
                >
                  Bold hook → stat → CTA
                </motion.div>
              </div>
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-6 py-3 text-sm font-semibold text-foreground shadow-md ring-1 ring-silver/10 transition hover:scale-105"
              >
        ...
        <section id="vs-firms" className="relative overflow-hidden bg-surface py-20 text-foreground">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute right-1/2 bottom-0 h-96 w-96 translate-x-1/2 rounded-full bg-gradient-to-br from-accent via-pink-400 to-accent opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-6 py-3 text-sm font-semibold text-foreground shadow-md ring-1 ring-umber/20 transition hover:scale-105"
              >
        ...
        <WaveDivider flip className="text-foreground" />
      </main>
      <FinalCTA />
      <FooterSection />
    </section>
