      ...
      >
        ...
        >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <p className="mt-10 text-center text-sm font-semibold text-silver">
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
              <div className="space-y-4 text-center md:text-left">
                ...
                <p className="mx-auto max-w-xl text-sm text-silver md:mx-0">
            ...
            <p className="text-center text-sm font-semibold text-silver">
            ...
            <div className="grid gap-8 text-sm md:grid-cols-2">
              ...
              >
                ...
                <p className="text-sm text-silver">Extras you don&rsquo;t actually need</p>
                <div className="pt-2">
                  <a
                    href="/webdev-landing"
                    data-event="cta-social-proof"
              ...
              >
                ...
                <p className="text-sm text-silver">The NPR no-bloat process</p>
                <div className="pt-2">
                  <a
                    href={Routes.contact}
