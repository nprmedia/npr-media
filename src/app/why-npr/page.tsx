...
export default function WhyNprPage() {
  return (
    <section>
      <StickyHeader />
      <main
        className="relative w-full overflow-x-hidden bg-[var(--color-bg-dark)] text-[var(--color-text-light)] space-y-28"
      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-[var(--color-accent)] via-[var(--color-accent-dark)] to-[var(--color-accent)] opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-16 px-4">
            ...
            <div className="space-y-16">
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
                  <h2 className="text-[clamp(1.4rem,3vw,2.25rem)] font-bold">What AI Can’t Do</h2>
              ...
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
                  <h2 className="text-[clamp(1.4rem,3vw,2.25rem)] font-bold">How NPR Media Delivers</h2>
            ...
            <p className="mx-auto mt-6 max-w-xl text-center text-sm text-[var(--color-gray-300)]">
            ...
            >
              <div className="w-1/2 pr-4 text-sm">
                ...
                <div className="rounded bg-[var(--color-accent-dark)] p-3 text-white">
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute bottom-0 right-1/2 h-96 w-96 translate-x-1/2 rounded-full bg-gradient-to-br from-[var(--color-accent)] via-[var(--color-accent-dark)] to-[var(--color-accent)] opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-16 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
