      ...
      >
        ...
        >
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <hr className="my-16 h-px border-0 bg-gradient-to-r from-transparent via-antique/50 to-transparent" />
          ...
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            ...
            <div className="pt-8 text-center">
              <a
                href="/webdev-landing"
                data-event="cta-social-proof"
                className="inline-block rounded-full bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-dark)] px-6 py-3 text-sm font-semibold text-silver shadow-md ring-1 ring-umber/10 transition hover:scale-105"
              >
