      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-pink-500 via-rose-500 to-red-400 opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="text-center space-y-3">
              ...
              <p className="text-[clamp(0.9rem,1.6vw,1.125rem)] text-[var(--color-accent)]">AI doesn’t think. It predicts. That leaves you with generic output and zero accountability.</p>
            ...
            <div className="space-y-12">
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-10 text-center md:pb-0 md:text-left space-y-3">
                  <h2 className="text-3xl sm:text-4xl font-bold">What AI Can’t Do</h2>
                  <p className="text-sm text-[var(--color-accent)]">Where automation falls short</p>
                  <div className="pt-3">
                    <a
                      href="/pricing"
                      className="inline-block rounded-full bg-[var(--color-accent)] px-4 py-2 text-xs font-semibold text-black shadow transition hover:bg-[var(--color-accent-dark)] hover:scale-105"
                    >
                      View examples
                    </a>
                  </div>
              ...
              <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
                <div className="pb-10 text-center md:pb-0 md:text-left space-y-3">
                  ...
                  <p className="text-sm text-[var(--color-accent)]">Human-guided strategy for real results</p>
                  <div className="pt-3">
                    <a
                      href="/pricing"
                      className="inline-block rounded-full bg-[var(--color-accent)] px-4 py-2 text-xs font-semibold text-black shadow transition hover:bg-[var(--color-accent-dark)] hover:scale-105"
            ...
            <div className="pt-8 text-center">
              <a
                href="/pricing"
                className="inline-block rounded-full bg-[var(--color-accent)] px-6 py-3 text-sm font-semibold text-black shadow-md ring-1 ring-white/10 transition hover:bg-[var(--color-accent-dark)] hover:scale-105"
              >
        ...
        >
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute bottom-0 right-1/2 h-96 w-96 translate-x-1/2 rounded-full bg-gradient-to-br from-pink-500 via-rose-500 to-red-400 opacity-30 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl space-y-12 px-4">
            <div className="md:grid md:grid-cols-2 md:items-center md:gap-8">
            ...
            <div className="pt-8 text-center">
              <a
                href="/about"
                className="inline-block rounded-full bg-[var(--color-accent)] px-6 py-3 text-sm font-semibold text-black shadow-md ring-1 ring-black/10 transition hover:bg-[var(--color-accent-dark)] hover:scale-105"
              >
