          ...
          <div className="container mx-auto max-w-6xl space-y-20 px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="rounded-xl bg-white/10 p-4 shadow-md backdrop-blur ring-1 ring-white/20 transition-transform hover:scale-105 text-white"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative mt-12 flex items-start justify-center rounded-2xl bg-white/5 p-6 shadow-lg ring-1 ring-white/10 text-white backdrop-blur md:p-8"
            >
              ...
              <div className="w-1/2 pl-4 text-sm">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="rounded border border-white/20 bg-white/10 p-3 shadow-inner text-white backdrop-blur-sm"
                >
                  Bold hook → stat → CTA
                </motion.div>
              </div>
          ...
          <div className="container mx-auto max-w-6xl space-y-20 px-4">
            ...
            <div className="grid gap-8 text-sm md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="space-y-2 rounded-xl bg-white p-4 shadow-md ring-1 ring-gray-200 transition-transform hover:scale-105 text-gray-800"
              >
