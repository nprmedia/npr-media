    ...
    <section>
      ...
      >
        ...
        <section className="relative bg-white text-black py-[clamp(4rem,8vw,6rem)] px-4">
          ...
          <div className="relative z-20 mx-auto flex max-w-3xl flex-col items-center space-y-6 text-center">
            <h2 className="text-2xl font-bold">Meet the CEO</h2>
            <div className="space-y-2">
              <div className="mx-auto h-40 w-40 rounded-full bg-gray-300" />
              <p className="text-lg font-normal">Taylor</p>
