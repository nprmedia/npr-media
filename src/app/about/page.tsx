    ...
    <section>
      ...
      >
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[clamp(0.9rem,1.6vw,1.125rem)] text-muted-foreground">
            ...
            <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
              ...
              <div className="pt-2">
                <CTAButton
                  ...
                  className="inline-block rounded-full bg-gradient-to-r from-accent to-accent px-4 py-2 text-xs font-normal text-muted-foreground shadow transition hover:scale-105"
                >
                  Work with us
                </CTAButton>
              </div>
        ...
        <section className="bg-background text-foreground py-[clamp(4rem,8vw,6rem)] px-4">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3 text-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Every build starts with clear goals so your site drives real revenue.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Senior Expertise</h3>
              <p className="text-sm text-muted-foreground">A compact team of vets ships faster than bloated agencies.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Proven Results</h3>
              <p className="text-sm text-muted-foreground">From SaaS dashboards to marketing sites, our work converts.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-background text-foreground py-[clamp(4rem,8vw,6rem)] px-4 text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">Let&rsquo;s craft a website that scales with you. See how our process works.</p>
          <div className="pt-6">
            <CTAButton
              href="/webdev-landing"
              event="cta-about-final"
              className="inline-block rounded-full bg-primary px-6 py-3 text-sm font-normal text-muted-foreground shadow-md transition hover:scale-105 hover:bg-primary/90"
            >
              See Our Process
            </CTAButton>
          </div>
