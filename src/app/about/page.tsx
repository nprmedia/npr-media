  ...
  return (
    <section>
      ...
      >
        ...
        {/* Values */}
        <section className="relative overflow-hidden py-20 bg-sepia text-charcoal">
        ...
        {/* Team */}
        <section className="relative bg-sepia text-charcoal py-[clamp(4rem,8vw,6rem)] px-4">
          ...
          <div className="pointer-events-none absolute inset-0 z-10 bg-sepia/60" />
        ...
        <section className="bg-antique text-charcoal py-[clamp(4rem,8vw,6rem)] px-4 text-center">
          ...
          <div className="pt-6">
            <CTAButton
              ...
              className="inline-block rounded-full bg-blood px-6 py-3 text-sm font-normal text-charcoal shadow-md transition hover:scale-105 hover:bg-blood"
            >
              See Our Process
            </CTAButton>
          </div>
