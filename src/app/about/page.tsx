    ...
    <section>
      ...
      >
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[clamp(0.9rem,1.6vw,1.125rem)] text-[var(--color-antique)]">
            We craft high-performing websites and systems that help founders and startups scale faster.
          </p>
        </section>

        {/* Values */}
        <section className="relative overflow-hidden py-20 bg-[var(--color-antique)] text-[var(--color-charcoal)]">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-[var(--color-blood)] to-[var(--color-crimson)] opacity-20 blur-3xl" />
          </div>
          <div className="container mx-auto max-w-6xl px-4 md:grid md:grid-cols-2 md:items-center md:gap-8">
            <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
              ...
              <p className="text-sm text-[var(--color-sepia)]">Principles that guide every build</p>
              <div className="pt-2">
                <CTAButton
                  href="/webdev-landing"
                  event="cta-about-values"
                  className="inline-block rounded-full bg-gradient-to-r from-[var(--color-blood)] to-[var(--color-crimson)] px-4 py-2 text-xs font-normal text-[var(--color-silver)] shadow transition hover:scale-105"
                >
                  Work with us
                </CTAButton>
              </div>
        ...
        <section className="bg-[var(--color-bg-dark)] text-[var(--color-text-light)] py-[clamp(4rem,8vw,6rem)] px-4">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3 text-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-[var(--color-sepia)]">Every build starts with clear goals so your site drives real revenue.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Senior Expertise</h3>
              <p className="text-sm text-[var(--color-sepia)]">A compact team of vets ships faster than bloated agencies.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Proven Results</h3>
              <p className="text-sm text-[var(--color-sepia)]">From SaaS dashboards to marketing sites, our work converts.</p>
            </div>
          </div>
        </section>

        {/* Team */}
        <section className="relative bg-[var(--color-antique)] text-[var(--color-charcoal)] py-[clamp(4rem,8vw,6rem)] px-4">
          ...
          <div className="pointer-events-none absolute inset-0 z-10 bg-[var(--color-antique)]/60" />
          <div className="relative z-20 mx-auto max-w-md text-center space-y-8">
            ...
            <div className="flex justify-center">
              <div className="space-y-2">
                ...
                <p className="text-sm text-[var(--color-sepia)]">Founder & CEO</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[var(--color-bg-dark)] text-[var(--color-text-light)] py-[clamp(4rem,8vw,6rem)] px-4 text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-[var(--color-antique)]">Let&rsquo;s craft a website that scales with you. See how our process works.</p>
          <div className="pt-6">
            <CTAButton
              href="/webdev-landing"
              event="cta-about-final"
              className="inline-block rounded-full bg-[var(--color-blood)] px-6 py-3 text-sm font-normal text-[var(--color-silver)] shadow-md transition hover:scale-105 hover:bg-[var(--color-crimson)]"
            >
              See Our Process
            </CTAButton>
          </div>
