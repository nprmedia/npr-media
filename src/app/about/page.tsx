    ...
    <section>
      ...
      >
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[clamp(0.9rem,1.6vw,1.125rem)] text-foreground">
        ...
        <section className="relative overflow-hidden py-20 bg-surface text-foreground">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <div className="absolute -top-10 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-accent via-pink-300 to-accent opacity-20 blur-3xl" />
          </div>
        ...
        <section className="bg-background text-foreground py-[clamp(4rem,8vw,6rem)] px-4">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3 text-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-foreground">Every build starts with clear goals so your site drives real revenue.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Senior Expertise</h3>
              <p className="text-sm text-foreground">A compact team of vets ships faster than bloated agencies.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold">Proven Results</h3>
              <p className="text-sm text-foreground">From SaaS dashboards to marketing sites, our work converts.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-background text-foreground py-[clamp(4rem,8vw,6rem)] px-4 text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-foreground">Let&rsquo;s craft a website that scales with you. See how our process works.</p>
          <div className="pt-6">
            <CTAButton
              href="/webdev-landing"
              event="cta-about-final"
              className="inline-block rounded-full bg-accent px-6 py-3 text-sm font-normal text-foreground shadow-md transition hover:scale-105 hover:bg-accent"
            >
              See Our Process
            </CTAButton>
          </div>
