  ...
  return (
    <section>
      ...
      >
        ...
        >
          <h1 className="text-[clamp(2rem,4vw,3rem)] font-light">About NPR Media</h1>
        ...
        <section className="relative overflow-hidden py-20 bg-white text-black">
          ...
          <div className="container mx-auto max-w-6xl px-4 md:grid md:grid-cols-2 md:items-center md:gap-8">
            <div className="pb-8 text-center md:pb-0 md:text-left space-y-2">
              <h2 className="text-3xl sm:text-4xl font-light">Values, Culture & Beliefs</h2>
          ...
          <div className="mx-auto max-w-4xl text-center space-y-8">
            ...
            <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
              <div className="space-y-2">
                ...
                <p className="font-light">Taylor</p>
                <p className="text-sm text-gray-400">Founder & Lead Dev</p>
              </div>
              <div className="space-y-2">
                <div className="mx-auto h-32 w-32 rounded-full bg-gray-600" />
                <p className="font-light">Jordan</p>
                <p className="text-sm text-gray-400">UX Engineer</p>
              </div>
              <div className="space-y-2">
                <div className="mx-auto h-32 w-32 rounded-full bg-gray-600" />
                <p className="font-light">Alex</p>
                <p className="text-sm text-gray-400">Growth Strategist</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[var(--color-bg-dark)] text-[var(--color-text-light)] py-[clamp(4rem,8vw,6rem)] px-4 text-center">
          <h2 className="text-2xl font-light">Ready to accelerate?</h2>
