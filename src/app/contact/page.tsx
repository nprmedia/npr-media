      ...
      <main className="flex flex-1 items-center px-6 py-12 lg:px-12">
        <div className="relative mx-auto w-full max-w-3xl space-y-8">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <motion.div
              className="h-72 w-72 rounded-full bg-sepia/30 blur-3xl"
          ...
          >
            ...
            <p className="mt-2 text-olive dark:text-sepia">{copy.subtext}</p>
          </motion.div>
          <ContactForm />
          <StickyCTA />
          <motion.div
          ...
          >
            <div className="flex flex-col items-center rounded-xl bg-antique/80 p-4 shadow-md ring-1 ring-umber/10 backdrop-blur-md dark:bg-umber/70 dark:ring-silver/10">
