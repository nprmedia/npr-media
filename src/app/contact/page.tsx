...
export default function ContactPage() {
  ...
  return (
    <section className="flex min-h-screen flex-col bg-antique text-charcoal">
      <StickyHeader light />
      <main className="flex flex-1 items-center px-6 py-12 lg:px-12">
        <div className="relative mx-auto w-full max-w-3xl space-y-8">
          ...
          >
            ...
            <p className="mt-2 text-charcoal">{copy.subtext}</p>
          </motion.div>
          <ContactForm />
          <StickyCTA />
          <motion.div
          ...
          >
            <div className="flex flex-col items-center rounded-xl bg-sepia/80 p-4 shadow-md ring-1 ring-umber/10 backdrop-blur-md">
