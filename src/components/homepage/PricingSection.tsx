                      ...
                      <div className={`relative rounded-2xl before:absolute before:inset-0 before:rounded-2xl ${isMiddleCard ? 'before:ring-2 before:ring-yellow-400 before:animate-pulse' : ''}`}>
                        ...
                        >
                          <CardContent className="p-5 space-y-4">
                            <div className="space-y-1">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <h3 className="text-[clamp(1rem,1.8vw,1.25rem)] font-semibold leading-tight text-[#F2F3F4]">
                                    {tier.title}
                                  </h3>
                                </div>
                                <p className="text-[clamp(1rem,1.8vw,1.25rem)] font-bold text-gray-300 whitespace-nowrap">
                                  {tier.price}
                                </p>
                              </div>
                              <p className="text-[clamp(0.8rem,1.2vw,0.9rem)] italic text-gray-400">
                            ...
                            <ul className="text-[clamp(0.8rem,1.2vw,0.9rem)] text-gray-300 space-y-2 max-h-[180px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700">
                              {tier.features.map((feature, i) => (
                                <li key={i} className={`flex items-start gap-2 ${i === 0 ? 'font-semibold text-[#F2F3F4]' : ''}`}>
                            ...
                            <div className="pt-2">
                              <button
                                className="group mt-4 inline-flex w-full justify-center items-center gap-2 rounded-full border border-gray-600 bg-gray-800 px-[clamp(1rem,2.5vw,1.25rem)] py-[clamp(0.6rem,1.2vw,0.75rem)] text-[clamp(0.8rem,1vw,0.9rem)] font-medium text-[#F2F3F4] shadow-sm hover:bg-gray-700 hover:scale-105 transition"
                              >
                                Start Plan
                                <ArrowRight className="w-4 h-4 opacity-70 group-hover:translate-x-1 transition-transform group-hover:opacity-100" />
                              </button>
                              <p className="text-[clamp(0.7rem,1vw,0.8rem)] text-center text-gray-400 mt-1 flex items-center justify-center gap-1 italic">
