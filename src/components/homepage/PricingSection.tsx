          ...
          {pricing.tiers.map((tier, index) => (
            ...
            >
              ...
              <div className="flex items-baseline justify-between">
                ...
                <span className="text-[clamp(1rem,1.8vw,1.25rem)] font-bold text-[var(--color-silver)]">
                  {tier.price}
                </span>
              </div>
              <p className="mt-1 text-[clamp(0.8rem,1.2vw,0.9rem)] italic text-[var(--color-sepia)]">
                {tier.microcopy}
              </p>
              <p className="mt-2 text-[clamp(0.8rem,1.2vw,0.9rem)] text-[var(--color-silver)]">
                {tier.description}
              </p>
              <ul className="mt-4 flex-1 space-y-1 text-[clamp(0.8rem,1.2vw,0.9rem)] text-[var(--color-silver)]">
