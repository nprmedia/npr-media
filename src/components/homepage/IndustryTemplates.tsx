    ...
    >
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-olive mt-2 text-[clamp(0.9rem,1.6vw,1.125rem)]">
        ...
        >
          ...
          >
            ...
            <p className="text-olive mb-1 text-[clamp(0.8rem,1.2vw,0.9rem)]">
            ...
            <div className="mt-auto text-[clamp(0.8rem,1vw,0.9rem)] font-medium">
              <a
                ...
                className="bg-[var(--color-accent)] text-charcoal hover:bg-[var(--color-accent-dark)] focus:ring-[var(--color-accent)] rounded-full px-[clamp(0.75rem,2vw,1rem)] py-[clamp(0.4rem,1vw,0.6rem)] transition hover:scale-105 focus:ring-2 focus:outline-none"
              >
                Open Demo →
              </a>
            </div>
