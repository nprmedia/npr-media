  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-y-0 right-[25%] z-20 hidden flex-col items-center justify-between md:flex"
        style={{ opacity: 0.12 }}
      >
        {['N', 'P', 'R'].map((letter) => (
          <motion.span
            ...
            className="text-primary/80 block font-extrabold"
            style={{ fontSize: '33.3vh', lineHeight: 1 }}
          >
            {letter}
          </motion.span>
        ))}
