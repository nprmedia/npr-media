...
export function HeroContent({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0 hidden items-center justify-center md:flex mix-blend-multiply">
        <span className="select-none font-grotesk font-extrabold uppercase leading-none tracking-tight text-sepia/20 text-[30vw]">
          NPR
        </span>
      </div>
