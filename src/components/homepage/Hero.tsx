  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        initial="hidden"
        animate="visible"
        className="absolute bottom-[2vh] left-1/2 z-20 -translate-x-1/2 p-2 text-blood opacity-70 transition hover:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blood"
      >
