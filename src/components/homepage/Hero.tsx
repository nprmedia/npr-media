  ...
  return (
    ...
    >
          ...
          {ctaText && ctaLink && (
            ...
            >
              ...
              <Link
                ...
                href={ctaLink}
                data-event="cta-hero"
                className="inline-flex items-center justify-center rounded-full px-4 py-[0.4rem] text-[clamp(0.7rem,1vw,0.9rem)] font-semibold text-charcoal shadow-lg ring-1 bg-blood transition"
              >
                {ctaText}
              </Link>
      ...
      <div className="absolute bottom-6 left-1/2 z-10 -translate-x-1/2 transform">
        <div className="text-blood animate-bounce text-lg drop-shadow-[0_0_4px_rgba(210,210,210,0.5)]">
          ↓
        </div>
      </div>

      {isStickyVisible && (
        <div className="fixed bottom-36 left-1/2 z-50 -translate-x-1/2 rounded-full bg-blood px-4 py-2 text-sm font-bold text-silver opacity-90 shadow-xl hover:scale-105">
