  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {placeholders.name && (
          <span className="pointer-events-none absolute top-1/2 left-10 -translate-y-1/2 text-sm text-muted-foreground">
            {placeholders.name}
          </span>
        )}
      </motion.div>
      ...
      <motion.button
        ...
        disabled={loading}
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-semibold text-muted-foreground shadow-md ring-2 ring-primary/50 transition-transform hover:shadow-lg disabled:opacity-60"
      >
        {loading ? (
