...
export default function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  const inputBase =
    'w-full rounded-md bg-antique/80 px-10 py-3 text-sm text-charcoal shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crimson/40';
  ...
  return (
    <motion.form
      ...
      className="space-y-6 rounded-2xl bg-antique/80 p-6 shadow-xl ring-1 shadow-charcoal/10 ring-transparent backdrop-blur-md hover:ring-crimson/20"
    >
      <motion.div
        className="relative"
      ...
      <motion.button
        ...
        disabled={loading}
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-blood py-3 font-semibold text-silver shadow-md ring-2 ring-crimson/50 transition-transform hover:bg-crimson hover:shadow-lg disabled:opacity-60"
      >
        {loading ? (
      ...
      <div className="space-y-1 text-center text-xs text-olive">
      ...
      {success && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="text-center text-sm text-olive"
        >
