...
export default function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  const inputBase =
    'w-full rounded-md bg-antique border-olive px-10 py-3 text-sm text-charcoal shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crimson';
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        disabled={loading}
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-umber py-3 font-semibold text-silver shadow-md ring-2 ring-crimson/50 transition-transform hover:shadow-lg disabled:opacity-60"
      >
        {loading ? (
