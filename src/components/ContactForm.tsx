...
export default function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  const inputBase =
    'w-full rounded-md bg-olive px-10 py-3 text-sm text-charcoal shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blood/40';
  ...
  return (
    <motion.form
      ...
      className="space-y-6 rounded-2xl bg-olive/80 p-6 shadow-xl ring-1 shadow-silver/20 ring-transparent backdrop-blur-md hover:ring-blood/40"
    >
      <motion.div
        className="relative"
