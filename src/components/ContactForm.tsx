...
export default function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  const inputBase =
    'w-full rounded-md bg-antique/80 px-10 py-3 text-sm text-charcoal shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blood/40';
  ...
  return (
    <motion.form
      ...
      className="space-y-6 rounded-2xl bg-antique/80 p-6 shadow-xl ring-1 shadow-black/10 ring-transparent backdrop-blur-md hover:ring-blood/20"
    >
      <motion.div
        className="relative"
      ...
      <motion.button
        ...
        disabled={loading}
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-blood py-3 font-semibold text-white shadow-md ring-2 ring-blood/50 transition-transform hover:bg-crimson hover:shadow-lg disabled:opacity-60"
      >
        {loading ? (
      ...
      <div className="space-y-1 text-center text-xs text-silver">
