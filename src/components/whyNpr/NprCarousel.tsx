            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === slides.indexOf(title) && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(16rem,40vw,22rem)] space-y-4 rounded-xl border border-silver/20 bg-gradient-to-br from-accent via-accent/90 to-accent p-6 text-center text-foreground shadow-2xl"
                >
