            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === slides.indexOf(title) && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(16rem,40vw,22rem)] space-y-4 rounded-xl bg-gradient-to-br from-purple-600 via-indigo-700 to-indigo-900 p-6 text-center text-gray-100 shadow-lg ring-1 ring-white/20 transition-transform hover:scale-105"
                >
