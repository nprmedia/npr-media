            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === slides.indexOf(title) && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(16rem,40vw,22rem)] space-y-4 rounded-xl border border-silver/10 bg-gradient-to-br from-blood via-crimson to-blood p-6 text-center text-silver shadow-2xl"
                >
