            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === i && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(18rem,60vw,28rem)] rounded-xl border border-silver/10 bg-gradient-to-br from-antique via-sepia to-antique p-6 text-charcoal shadow-2xl"
                >
                  <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-center gap-4">
                    <div>
                      <p className="text-xs font-semibold text-olive">Other Firms</p>
                      <p className="text-sm">{row.other}</p>
                    </div>
                    <ArrowRight className="mx-auto text-olive" />
                    <div>
                      <p className="text-xs font-semibold text-olive">NPR Media</p>
                      <p className="text-sm">{row.npr}</p>
                    </div>
                    <ArrowRight className="mx-auto text-olive" />
                    <div>
                      <p className="text-xs font-semibold text-olive">Your Gain</p>
