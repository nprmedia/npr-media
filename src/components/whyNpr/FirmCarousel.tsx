            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === i && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(18rem,60vw,28rem)] rounded-xl border border-umber/10 bg-gradient-to-br from-antique via-sepia to-antique p-6 text-charcoal shadow-2xl"
                >
