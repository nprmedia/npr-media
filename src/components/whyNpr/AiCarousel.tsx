            ...
            <AnimatePresence mode="wait" initial={false}>
              {index === aiSlides.indexOf(title) && (
                <motion.div
                  ...
                  className="mx-auto w-[clamp(16rem,35vw,24rem)] space-y-5 rounded-2xl bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 p-8 text-center text-gray-100 shadow-2xl ring-1 ring-white/10"
                >
