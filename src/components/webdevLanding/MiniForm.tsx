...
export default function MiniForm() {
  ...
  const labelBase = 'pointer-events-none absolute left-10 top-1/2 -translate-y-1/2 text-sm text-muted-foreground transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-focus:top-2 peer-focus:-translate-y-0 peer-focus:text-xs'
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-semibold text-muted-foreground shadow-md transition hover:bg-primary/90"
      >
      ...
      {success && <p className="pt-2 text-center text-sm text-muted-foreground">We’ll be in touch shortly.</p>}
    </motion.form>
  )
}
