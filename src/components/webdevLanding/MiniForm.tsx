...
export default function MiniForm() {
  ...
  const baseInput = 'peer w-full rounded-md bg-sepia/80 px-10 py-3 text-sm text-charcoal shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blood/40 placeholder-transparent'
  ...
  return (
    <motion.form
      ...
      className="space-y-4 rounded-2xl bg-sepia/20 p-6 shadow-xl ring-1 ring-silver/20 backdrop-blur"
    >
