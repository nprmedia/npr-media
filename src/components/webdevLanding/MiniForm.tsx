...
export default function MiniForm() {
  ...
  return (
    <motion.form
      ...
      className="space-y-4 rounded-2xl bg-antique/20 p-6 shadow-xl ring-1 ring-white/10 backdrop-blur"
    >
      ...
      <motion.button
        ...
        className="relative flex w-full items-center justify-center gap-2 rounded-xl bg-blood py-3 font-semibold text-white shadow-md transition hover:bg-crimson"
      >
