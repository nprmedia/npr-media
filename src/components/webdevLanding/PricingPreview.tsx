    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-20 text-center">
        ...
        <motion.a
          ...
          className="mt-8 inline-block rounded-full bg-[var(--color-blood)] px-6 py-3 font-semibold text-[var(--color-silver)] shadow-lg transition hover:scale-105 hover:bg-[var(--color-crimson)]"
        >
        ...
        <motion.p
          ...
          className="mt-4 text-sm text-[var(--color-charcoal)]"
        >
