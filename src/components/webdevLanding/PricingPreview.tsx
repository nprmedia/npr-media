    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-20 text-center">
        ...
        <motion.a
          ...
          className="mt-8 inline-block rounded-full bg-primary px-6 py-3 font-semibold text-muted-foreground shadow-lg transition hover:scale-105 hover:bg-primary/90"
        >
