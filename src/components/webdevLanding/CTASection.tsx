...
export default function CTASection() {
  return (
    <section id="cta" className="relative bg-gradient-to-br from-muted via-primary to-primary/90 py-24 text-muted-foreground">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:px-12 lg:px-20 md:grid-cols-2">
        ...
        >
          ...
          <ul className="list-disc pl-5 text-sm marker:text-muted-foreground">
            <li>Actionable page-level insights</li>
            <li>Senior dev & design expertise</li>
            <li>100% obligation-free</li>
          </ul>
          <p className="text-sm text-muted-foreground">Prefer to schedule a call? <a href="https://calendly.com" target="_blank" className="underline">Book via Calendly</a></p>
        </motion.div>
        <MiniForm />
      </div>
    </section>
