...
export default function CTASection() {
  return (
    <section id="cta" className="relative bg-gradient-to-br from-antique via-blood to-blood py-24 text-charcoal">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:px-12 lg:px-20 md:grid-cols-2">
        ...
        >
          ...
          <ul className="list-disc space-y-1 break-words pl-5 text-sm marker:text-charcoal">
