...
export default function CTASection() {
  return (
    <section id="cta" className="relative bg-gradient-to-br from-umber via-olive to-umber py-24 text-silver">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:px-12 lg:px-20 md:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm text-blood">Prefer to schedule a call? <a href="https://calendly.com" target="_blank" className="underline">Book via Calendly</a></p>
        </motion.div>
        <MiniForm />
      </div>
    </section>
