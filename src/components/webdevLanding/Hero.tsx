    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-umber via-olive to-charcoal text-center text-silver">
      ...
      >
        ...
        <motion.a
          ...
          className="mt-8 inline-block rounded-full bg-blood px-6 py-3 font-semibold text-white shadow-lg ring-1 ring-white/10 transition hover:bg-crimson hover:scale-105"
        >
          {cta}
        </motion.a>
      </motion.div>
