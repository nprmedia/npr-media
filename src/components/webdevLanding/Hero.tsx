    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-antique via-blood to-blood text-center text-charcoal">
      ...
      >
        ...
        <motion.a
          ...
          className="mt-8 inline-block rounded-full bg-sepia px-6 py-3 font-semibold text-charcoal shadow-lg ring-1 ring-silver/20 transition hover:scale-105 hover:bg-sepia"
        >
          {cta}
        </motion.a>
      </motion.div>
