...
export default function Hero({ headline, subheadline, cta }: HeroProps) {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-umber via-olive to-blood text-center text-silver">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      >
        ...
        <motion.a
          ...
          className="mt-8 inline-block rounded-full bg-blood px-6 py-3 font-semibold text-silver shadow-lg ring-1 transition hover:bg-crimson hover:scale-105"
        >
          {cta}
        </motion.a>
      </motion.div>
