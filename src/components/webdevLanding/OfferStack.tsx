        ...
        <div className="mt-12 grid gap-8 md:grid-cols-5">
          {items.map((item, i) => (
            <motion.div
              ...
              className="rounded-2xl bg-[var(--color-antique)]/70 p-6 text-center shadow-xl ring-1 ring-[var(--color-charcoal)]/10 backdrop-blur-md hover:shadow-2xl"
            >
              <item.icon className="mx-auto mb-3 h-6 w-6 text-[var(--color-blood)]" />
