  ...
  return (
    <div className="relative mx-auto h-screen max-w-md overflow-hidden bg-antique">
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10" style={{ height: '33%' }}>
        <div className="h-full bg-gradient-to-b from-antique via-silver/80 to-transparent" />
      </div>
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 z-10"
        style={{ height: '33%' }}
      >
        <div className="h-full bg-gradient-to-t from-antique via-silver/80 to-transparent" />
      </div>
      <div
        ref={containerRef}
          ...
          return (
            <section key={slide.title} className="snap-center py-4">
              ...
              >
                ...
                <p className="mt-2 text-lg leading-relaxed text-olive">{slide.description}</p>
              </motion.div>
            </section>
          );
        })}
